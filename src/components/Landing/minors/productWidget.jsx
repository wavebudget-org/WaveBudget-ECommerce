  ...
  return (
    <div className="mt-[1rem] px-[2%] md:px-[1%] lg:px-[2%] space-y-[1rem]">
      ...
      <div className="mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 gap-5">
        {items?.map(({ name, qty, description, storeName, id, images, price }, idx) => {
          ...
          return (
            <div
              ...
              <LandingWidget name={name.stringValue} image={images[0]} id={id} descriptions={description.stringValue} price={price.stringValue} />
            </div>
          );
        })}
      </div>
