  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="let mx-auto swipeIn py-2 mt-[55px] text-zinc-700 min-[450px]:mt-[68px] w-full sm:w-[95%] min-[1000px]:w-[80%] xl:w-[82%] pb-[5rem] sm:pb-[5rem] float-right px-2 text-">
        <div className="grid grid-cols-4 px-2  border-zinc-700 w-full mx-auto ">
        ...
        {myCustomers?.map(({ name, userId, phone }, idx) => {
          return (
            <div key={idx} className="grid grid-cols-4  py-2 px-2 border-b border-zinc-400 w-full items-center mx-auto b">
